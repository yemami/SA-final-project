...
public class ElementAdminstrationApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Element element = new Element("head", 20);
...
//        System.out.println("\n--------------- update Element-----------------------\n");
//        Element elementForUpdate = new Element("head", 34);
//        restTemplate.put(serverURL+"/update/"+elementForUpdate.getType(), elementForUpdate);

        System.out.println("\n--------------- delete Element-----------------------\n");
        restTemplate.delete(serverURL+"/{elementId}", "head");
